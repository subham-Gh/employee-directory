!function(t, e) {
    ...
    "use strict";
    var t;
    return p = p && p.hasOwnProperty("default") ? p.default : p,
        ...
        var f, c = function(t, e, i) {
            if (null != t || null != e || null != i) {
                var n = function(s) {
                    ...
                    A.ajax = function(t) {
                        var e;
                        return (e = u.XMLHttpRequest ? new u.XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP")) ? (e.open("GET", t, !1),
                        e.send(null),
                        e.responseText) : null
                    }
                    ,
                    A.parseXml = function(e) {
                        ...
                        try {
                            var n = new u.DOMParser(s.xmldom || {});
                            return n.parseFromString(e, "image/svg+xml")
                        } catch (t) {
                            return (n = new u.DOMParser(s.xmldom || {})).parseFromString(e, "text/xml")
                        }
                    }
                    ,
                    ...
                    A.Property.prototype.getEM = function(t) {
                        ...
                        return i.hasValue() && (e = i.toPixels(t)),
                        e
                    }
                    ,
                    ...
                    A.Property.prototype.toPixels = function(t, e) {
                        ...
                        if (i.match(/%$/))
                            return this.numValue() * A.ViewPort.ComputeSize(t);
                        var n = this.numValue();
                    ...
                    A.Font = new function() {
                        ...
                        this.Parse = function(t) {
                            for (var e = {}, i = A.trim(A.compressSpaces(t || "")).split(" "), n = {
                                ...
                                n.fontStyle || -1 == r.Styles.indexOf(i[a]) ? n.fontVariant || -1 == r.Variants.indexOf(i[a]) ? n.fontWeight || -1 == r.Weights.indexOf(i[a]) ? n.fontSize ? "inherit" != i[a] && (s += i[a]) : ("inherit" != i[a] && (e.fontSize = i[a].split("/")[0]),
                                n.fontStyle = n.fontVariant = n.fontWeight = n.fontSize = !0) : ("inherit" != i[a] && (e.fontWeight = i[a]),
                                n.fontStyle = n.fontVariant = n.fontWeight = !0) : ("inherit" != i[a] && (e.fontVariant = i[a]),
                                n.fontStyle = n.fontVariant = !0) : ("inherit" != i[a] && (e.fontStyle = i[a]),
                                n.fontStyle = !0);
                            return "" != s && (e.fontFamily = s),
                            e
                        }
                    }
                    ,
                            ...
                            for (var f = 0; f <= 1; f++) {
                                ...
                                if (0 != d) {
                                    ...
                                    if (!(v < 0)) {
                                        ...
                                        0 < g && g < 1 && (0 == f && this.addX(p(g)),
                                        1 == f && this.addY(p(g)));
                                        var x = (-m - Math.sqrt(v)) / (2 * d);
                                        0 < x && x < 1 && (0 == f && this.addX(p(x)),
                                        1 == f && this.addY(p(x)))
                                    }
                                } else {
                                    if (0 == m)
                    ...
                    A.Transform = function(t) {
                        ...
                        this.Type.SkewBase = function(t) {
                            ...
                            this.base(t),
                            this.angle = new A.Property("angle",t)
                        }
                        ,
                    ...
                    A.AspectRatio = function(t, e, i, n, s, a, r, o, l, h) {
                        ...
                        l.hasValue() && h.hasValue() ? t.translate(-m * l.toPixels("x"), -m * h.toPixels("y")) : (u.match(/^xMid/) && ("meet" == c && m == p || "slice" == c && d == p) && t.translate(i / 2 - n / 2, 0),
                        u.match(/YMid$/) && ("meet" == c && m == f || "slice" == c && d == f) && t.translate(0, s / 2 - a / 2),
                        u.match(/^xMax/) && ("meet" == c && m == p || "slice" == c && d == p) && t.translate(i - n, 0),
                        u.match(/YMax$/) && ("meet" == c && m == f || "slice" == c && d == f) && t.translate(0, s - a)),
                        "none" == u ? t.scale(f, p) : "meet" == c ? t.scale(m, m) : "slice" == c && t.scale(d, d),
                    ...
                    A.Element.ElementBase = function(a) {
                        ...
                        this.attribute = function(t, e) {
                            ...
                            return null != i ? i : (1 == e && (i = new A.Property(t,""),
                            this.attributes[t] = i),
                            i || A.EmptyProperty)
                        }
                        ,
                        ...
                        if (null != a && 1 == a.nodeType) {
                            ...
                            for (this.attribute("id").hasValue() && null == A.Definitions[this.attribute("id").value] && (A.Definitions[this.attribute("id").value] = this),
                    ...
                    A.Element.RenderedElementBase = function(t) {
                        ...
                        this.setContext = function(t) {
                            ...
                            if (this.style("fill-opacity").hasValue() && (i = (i = new A.Property("fill",t.fillStyle)).addOpacity(this.style("fill-opacity")),
                            t.fillStyle = i.value),
                            ...
                            if (this.style("stroke-opacity").hasValue() && (n = (n = new A.Property("stroke",t.strokeStyle)).addOpacity(this.style("stroke-opacity")),
                            ...
                            this.style("stroke-dasharray").hasValue() && "none" != this.style("stroke-dasharray").value) {
                                ...
                                void 0 !== t.lineDashOffset ? t.lineDashOffset = r : void 0 !== t.webkitLineDashOffset ? t.webkitLineDashOffset = r : void 0 !== t.mozDashOffset && (t.mozDashOffset = r)
                            }
                            if (void 0 !== t.font && (t.font = A.Font.CreateFont(this.style("font-style").value, this.style("font-variant").value, this.style("font-weight").value, this.style("font-size").hasValue() ? this.style("font-size").toPixels() + "px" : "", this.style("font-family").value).toString()),
                    ...
                    A.Element.svg = function(t) {
                        ...
                        this.setContext = function(t) {
                            ...
                            t.lineJoin = "miter",
                            t.miterLimit = 4,
                            t.canvas.style && void 0 !== t.font && void 0 !== u.getComputedStyle && (t.font = u.getComputedStyle(t.canvas).getPropertyValue("font")),
                            ...
                            void 0 === this.root) {
                                ...
                                var n = 0
                                  , s = 0;
                                this.attribute("refX").hasValue() && this.attribute("refY").hasValue() && (n = -this.attribute("refX").toPixels("x"),
                            ...
                            this.attribute("viewBox").hasValue()) {
                                ...
                                e = a[2],
                                i = a[3],
                                A.AspectRatio(t, this.attribute("preserveAspectRatio").value, A.ViewPort.width(), e, A.ViewPort.height(), i, r, o, this.attribute("refX").value, this.attribute("refY").value),
                                A.ViewPort.RemoveCurrent(),
                    ...
                    A.Element.rect = function(t) {
                        ...
                        this.path = function(t) {
                            ...
                            return this.attribute("rx").hasValue() && !this.attribute("ry").hasValue() && (r = a),
                    ...
                    A.Element.circle = function(t) {
                        ...
                        this.path = function(t) {
                            ...
                            t.closePath()),
                            new A.BoundingBox(e - n,i - n,e + n,i + n)
                        }
                    }
                    ,
                    ...
                    A.Element.line = function(t) {
                        ...
                        this.path = function(t) {
                            ...
                            new A.BoundingBox(e[0].x,e[0].y,e[1].x,e[1].y)
                        }
                        ,
                        this.getMarkers = function() {
                    ...
                    A.Element.path = function(t) {
                        ...
                        for (e = (e = e.replace(/([^\s])([MmZzLlHhVvCcSsQqTtAa])/gm, "$1 $2")).replace(/([0-9])([+\-])/gm, "$1 $2"),
                        i = 0; i < 2; i++)
                            ...
                            for (null != t && t.beginPath(); !e.isEnd(); )
                                ...
                                case "a":
                                    for (; !e.isCommandOrEnd(); ) {
                                        ...
                                        new A.Point(Math.cos(f) * (r.x - h.x) / 2 + Math.sin(f) * (r.y - h.y) / 2,-Math.sin(f) * (r.x - h.x) / 2 + Math.cos(f) * (r.y - h.y) / 2))
                                          , y = Math.pow(d.x, 2) / Math.pow(u, 2) + Math.pow(d.y, 2) / Math.pow(c, 2);
                                        1 < y && (u *= Math.sqrt(y),
                                        c *= Math.sqrt(y));
                                        var v = (p == m ? -1 : 1) * Math.sqrt((Math.pow(u, 2) * Math.pow(c, 2) - Math.pow(u, 2) * Math.pow(d.y, 2) - Math.pow(c, 2) * Math.pow(d.x, 2)) / (Math.pow(u, 2) * Math.pow(d.y, 2) + Math.pow(c, 2) * Math.pow(d.x, 2)));
                                        isNaN(v) && (v = 0);
                                        ...
                                        if (e.addMarkerAngle(S, M - V * Math.PI / 2),
                                        e.addMarkerAngle(h, M - V * Math.PI),
                                        i.addPoint(h.x, h.y),
                                        null != t) {
                                            P = c < u ? u : c;
                                            var k = c < u ? 1 : u / c
                    ...
                    A.Element.GradientBase = function(t) {
                        ...
                        this.createGradient = function(t, e, i) {
                            ...
                            if (null == a)
                                return s(n.stops[n.stops.length - 1].color);
                            ...
                            if (this.attribute("gradientTransform").hasValue()) {
                                ...
                                h.attributes.transform = new A.Property("transform",this.attribute("gradientTransform").value),
                                h.children = [l];
                    ...
                    A.Element.radialGradient = function(t) {
                        ...
                        this.getGradient = function(t, e) {
                            ...
                            var n = "objectBoundingBox" == this.gradientUnits() ? i.x() + i.width() * this.attribute("cx").numValue() : this.attribute("cx").toPixels("x")
                              ...
                              , a = n
                              , r = s;
                            this.attribute("fx").hasValue() && (a = "objectBoundingBox" == this.gradientUnits() ? i.x() + i.width() * this.attribute("fx").numValue() : this.attribute("fx").toPixels("x")),
                    ...
                    A.Element.AnimateBase = function(t) {
                        ...
                        this.update = function(t) {
                            ...
                            if (this.begin < this.duration) {
                                ...
                                this.attribute("type").hasValue() && (i = this.attribute("type").value + "(" + i + ")"),
                    ...
                    A.Element.font = function(t) {
                        ...
                        for (var e = 0; e < this.children.length; e++) {
                            var i = this.children[e];
                            "font-face" == i.type ? (this.fontFace = i).style("font-family").hasValue() && (A.Definitions[i.style("font-family").value] = this) : "missing-glyph" == i.type ? this.missingGlyph = i : "glyph" == i.type && ("" != i.arabicForm ? (this.isRTL = !0,
                            this.isArabic = !0,
                    ...
                    A.Element.text = function(t) {
                        ...
                        this.renderChild = function(t, e, i, n) {
                            var s = i.children[n];
                            for (s.attribute("x").hasValue() ? (s.x = s.attribute("x").toPixels("x") + e.getAnchorDelta(t, i, n),
                            s.attribute("dx").hasValue() && (s.x += s.attribute("dx").toPixels("x"))) : (s.attribute("dx").hasValue() && (e.x += s.attribute("dx").toPixels("x")),
                            s.x = e.x),
                            e.x = s.x + s.measureText(t),
                            s.attribute("y").hasValue() ? (s.y = s.attribute("y").toPixels("y"),
                            s.attribute("dy").hasValue() && (s.y += s.attribute("dy").toPixels("y"))) : (s.attribute("dy").hasValue() && (e.y += s.attribute("dy").toPixels("y")),
                            s.y = e.y),
                            e.y = s.y,
                            s.render(t),
                            n = 0; n < s.children.length; n++)
                    ...
                    A.Element.TextElementBase = function(t) {
                        ...
                        this.getGlyph = function(t, e, i) {
                            ...
                            if (t.isArabic) {
                                ...
                                s = t.glyphs[n];
                            return null == s && (s = t.missingGlyph),
                            s
                        }
                        ,
                        this.renderChildren = function(t) {
                            ...
                            if (null == e)
                                "stroke" == t.paintOrder ? ("" != t.strokeStyle && t.strokeText(A.compressSpaces(this.getText()), this.x, this.y),
                                "" != t.fillStyle && t.fillText(A.compressSpaces(this.getText()), this.x, this.y)) : ("" != t.fillStyle && t.fillText(A.compressSpaces(this.getText()), this.x, this.y),
                        ...
                        if ("" != e) {
                            ...
                            this.renderChildren = function(t) {
                                var e = this.attribute("x").toPixels("x")
                                  ...
                                  , s = this.attribute("height").toPixels("y");
                                0 != n && 0 != s && (t.save(),
                                a ? t.drawSvg(this.img, e, i, n, s) : (t.translate(e, i),
                    ...
                    A.Element.g = function(t) {
                        ...
                        this.base(t),
                        this.getBoundingBox = function() {
                            for (var t = new A.BoundingBox, e = 0; e < this.children.length; e++)
                                ...
                                for (var s = n[i].split("{"), a = s[0].split(","), r = s[1].split(";"), o = 0; o < a.length; o++) {
                                    ...
                                    if ("" != l) {
                                        for (var h = A.Styles[l] || {}, u = 0; u < r.length; u++) {
                                            ...
                                            null != f && null != p && (h[A.trim(f)] = new A.Property(A.trim(f),A.trim(p)))
                                        }
                                        if (A.Styles[l] = h,
                                        A.StylesSpecificity[l] = w(l),
                                        "@font-face" == l)
                                            for (var m = h["font-family"].value.replace(/"/g, ""), d = h.src.value.split(","), y = 0; y < d.length; y++)
                    ...
                    A.Element.use = function(t) {
                        ...
                        this.renderChildren = function(t) {
                            if (null != n) {
                                var e = n;
                                "symbol" == n.type && ((e = new A.Element.svg).type = "svg",
                                ...
                                "svg" == e.type && (this.attribute("width").hasValue() && (e.attributes.width = new A.Property("width",this.attribute("width").value)),
                        ...
                        this.apply = function(t, e) {
                            ...
                            if (0 == s && 0 == a) {
                                for (var r = new A.BoundingBox, o = 0; o < this.children.length; o++)
                                    r.addBoundingBox(this.children[o].getBoundingBox());
                                i = Math.floor(r.x1),
                                n = Math.floor(r.y1),
                    ...
                    A.Element.filter = function(t) {
                        ...
                        this.apply = function(t, e) {
                            ...
                            for (p.translate(-n + l, -s + h),
                            e.render(p),
                            u = 0; u < this.children.length; u++)
                                "function" == typeof this.children[u].apply && this.children[u].apply(p, 0, 0, a + 2 * l, r + 2 * h);
                            t.drawImage(f, 0, 0, a + 2 * l, r + 2 * h, n - l, s - h, a + 2 * l, r + 2 * h),
                    ...
                    A.Element.feGaussianBlur = function(t) {
                        ...
                        this.apply = function(t, e, i, n, s) {
                            d && void 0 !== d.canvasRGBA ? (t.canvas.id = A.UniqueId(),
                            t.canvas.style.display = "none",
                            document.body.appendChild(t.canvas),
                            d.canvasRGBA(t.canvas, e, i, n, s, this.blurRadius),
                            document.body.removeChild(t.canvas)) : A.log("ERROR: StackBlur.js must be included for blur to work")
                        }
                    }
                    ,
                    ...
                    A.CreateElement = function(t) {
                        ...
                        e = e.replace(/\-/g, "");
                        var i = null;
                        return (i = void 0 !== A.Element[e] ? new A.Element[e](t) : new A.Element.MISSING(t)).type = t.nodeName,
                        i
                    }
                    ,
                    A.load = function(t, e) {
                    ...
                    A.loadXmlDoc = function(a, r) {
                        ...
                        var i = function(t) {
                            for (var e = a.canvas; e; )
                                ...
                                t.y -= e.offsetTop,
                                e = e.offsetParent;
                            return u.scrollX && (t.x += u.scrollX),
                            u.scrollY && (t.y += u.scrollY),
                            t
                        };
                        ...
                        var l = !0
                          , n = function() {
                            A.ViewPort.Clear(),
                            a.canvas.parentNode ? A.ViewPort.SetCurrent(a.canvas.parentNode.clientWidth, a.canvas.parentNode.clientHeight) : A.ViewPort.SetCurrent(800, 600),
                            1 != A.opts.ignoreDimensions && (o.style("width").hasValue() && (a.canvas.width = o.style("width").toPixels("x"),
                            a.canvas.style && (a.canvas.style.width = a.canvas.width + "px")),
                            o.style("height").hasValue() && (a.canvas.height = o.style("height").toPixels("y"),
                            ...
                            if (1 == A.opts.ignoreDimensions && o.style("width").hasValue() && o.style("height").hasValue() && (t = o.style("width").toPixels("x"),
                            ...
                            null != A.opts.scaleWidth || null != A.opts.scaleHeight) {
                                ...
                                null != A.opts.scaleWidth && (o.attribute("width").hasValue() ? i = o.attribute("width").toPixels("x") / A.opts.scaleWidth : isNaN(s[2]) || (i = s[2] / A.opts.scaleWidth)),
                                null != A.opts.scaleHeight && (o.attribute("height").hasValue() ? n = o.attribute("height").toPixels("y") / A.opts.scaleHeight : isNaN(s[3]) || (n = s[3] / A.opts.scaleHeight)),
                                null == i && (i = n),
                                null == n && (n = i),
                            ...
                            o.render(a),
                            l && (l = !1,
                            "function" == typeof A.opts.renderCallback && A.opts.renderCallback(r))
                        }
                          , s = !0;
                        A.ImagesLoaded() && (s = !1,
                        n()),
                        A.intervalID = setInterval(function() {
                            var t = !1;
                            if (s && A.ImagesLoaded() && (t = !(s = !1)),
                            1 != A.opts.ignoreMouse && (t |= A.Mouse.hasEvents()),
                            1 != A.opts.ignoreAnimation)
                                for (var e = 0; e < A.Animations.length; e++)
                                    t |= A.Animations[e].update(1e3 / A.FRAMERATE);
                            "function" == typeof A.opts.forceRedraw && 1 == A.opts.forceRedraw() && (t = !0),
                            t && (n(),
                            A.Mouse.runEvents())
                        }, 1e3 / A.FRAMERATE)
                    }
...
//# sourceURL=https://flpnwc-d7yx8rj4ud.dispatcher.ca1.hana.ondemand.com/sap/fiori/slsevicoereporadn/libs/canvg-dbg.js?eval
